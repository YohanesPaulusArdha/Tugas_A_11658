...
#load model
model_directory = r'"D:\Semester 5\PMDPM\Tugas_A_11658"' 

#os.path.join() untuk menggabungkan direktori dan file model pickle
...
if os.path.exists(model_path):
    try:
        ...
        bloodPressure = st.slider("Blood Pressure (mmHg)", min_value=0, max_value=122, step=2) skinThickness =st.slider("Skin Thickness (mm)", min_value=0, max_value=99, step=2)
